...
const HelpTwo = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <Image source={require('../assets/help2.png')} style={styles.image} />
        <TouchableOpacity style={styles.button} onPress={() => handleNavigate('HelpThree')}>
